...
SOURCES = snake.cpp mzapo_phys.c mzapo_parlcd.c display.cpp led-line.cpp led-rgb.cpp font_prop14x16.c text.cpp knobs.cpp menu.cpp audio.cpp player.cpp game.cpp wArial_88.c
